...
// - PROYECTO: filtro de categorías disponibles para cada usuario.
class ElectionList extends Component
{
    ...
    public function render()
    {
        ...
        // Trae elecciones con sus categorías y votos para evitar consultas repetidas.
        $elecciones = Election::with(['categories.votes'])
            ->orderBy('start_date', 'desc')
            ->get()
            ->map(function ($eleccion) use ($usuario, $idsCategoriasUsuario) {
                // PROYECTO:
                // categorias_usuario = solo categorías asignadas directamente a este usuario.
                ...
                // PROYECTO:
                // usuario_ha_votado_todo = true si ya votó en todas sus categorías permitidas.
